class uf_ds:
    parent_node = {}
    def make_set(self, u):
        for i in u: self.parent_node[i] = i
...
class Solution:
    def minCostConnectPoints(self, points: List[List[int]]) -> int:
        """
        Runtime: 2996 ms, faster than 34.96% of Python3 online submissions for Min Cost to Connect All Points.
        Memory Usage: 102.4 MB, less than 31.10% of Python3 online submissions for Min Cost to Connect All Points.
        """
