class Solution:
    def cherryPickup(self, grid: List[List[int]]) -> int:
        """
        Runtime: 639 ms, faster than 90.39% of Python3 online submissions for Cherry Pickup.
        Memory Usage: 23.1 MB, less than 62.86% of Python3 online submissions for Cherry Pickup.
        """
        # top down dp
        n = len(grid) 
        ...
        def dp(row_1, col_1, row_2):
            ...
            # border or -1
            if (row_1 == n or col_1 == n or row_2 == n or col_2 == n or
                grid[row_1][col_1] == -1 or grid[row_2][col_2] == -1):
                return float("-inf")
            # goal
            elif row_1 == n-1 and col_1 == n-1:
